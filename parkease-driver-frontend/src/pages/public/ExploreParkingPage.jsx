...
export default function ExploreParkingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#EDE8F5]">
      ...
      <div className="container mx-auto px-4 max-w-7xl py-6">
        <div className="bg-white border border-[#ADBBDA] rounded-2xl 
                        p-4 mb-5 shadow-card">
          <div className="flex flex-col sm:flex-row sm:items-center 
                          sm:justify-between gap-2">
            <div>
              <h1 className="text-xl sm:text-2xl font-black text-[#3D52A0]">
                Explore Parking
              </h1>
              <p className="text-sm text-[#8697C4]">
                Browse public lots and availability. Sign in to book.
              </p>
            </div>
            <button
              onClick={() => navigate('/auth/login')}
              ...
              {loading ? (
                ...
                lots.map((lot) => (
                  <LotCard
                    ...
                    onView={() => navigate(`/explore/lots/${lot.lotId}`)}
                  />
                ))
              )}
            </div>
                  ...
                  >
                    <Popup>
                      <div className="min-w-[180px] p-1">
                        ...
                        <button
                          onClick={() =>
                            navigate(`/explore/lots/${lot.lotId}`)
                          }
